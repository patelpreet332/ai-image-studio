...
case "$gpu_info" in
    *"Navi 1"*)
        ...
        then
            ...
            if [[ $pyv == "3.8" ]]
            then
                export TORCH_COMMAND="pip install https://download.pytorch.org/whl/torch/torch-2.4.0+rocm6.1-cp38-cp38-linux_x86_64.whl https://download.pytorch.org/whl/torchvision/torchvision-0.20.0+rocm6.1-cp38-cp38-linux_x86_64.whl"
            elif [[ $pyv == "3.9" ]]
            then
                export TORCH_COMMAND="pip install https://download.pytorch.org/whl/torch/torch-2.8.0+rocm6.4-cp39-cp39-manylinux_2_28_x86_64.whl https://download.pytorch.org/whl/torchvision/torchvision-0.23.0+rocm6.4-cp39-cp39-manylinux_2_28_x86_64.whl"
            elif [[ $pyv == "3.10" ]]
            then
                export TORCH_COMMAND="pip install https://download.pytorch.org/whl/torch/torch-2.9.0+rocm6.4-cp310-cp310-manylinux_2_28_x86_64.whl https://download.pytorch.org/whl/torchvision/torchvision-0.24.0+rocm6.4-cp310-cp310-manylinux_2_28_x86_64.whl"
            else
