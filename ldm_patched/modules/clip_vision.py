...
IMAGE_ENCODERS = {
    "clip_vision_model": ldm_patched.modules.clip_model.CLIPVisionModelProjection,
    "siglip_vision_model": ldm_patched.modules.clip_model.CLIPVisionModelProjection,
