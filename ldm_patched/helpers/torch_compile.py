...
if TYPE_CHECKING:
    ...
    from ldm_patched.modules.patcher_extension import WrapperExecutor
    ...
    def apply_torch_compile_wrapper(executor: WrapperExecutor, *args, **kwargs):
        try:
            ...
            for key, value in compiled_module_dict.items():
                orig_modules[key] = ldm_patched.modules.utils.get_attr(executor.class_obj, key)
                ldm_patched.modules.utils.set_attr(executor.class_obj, key, value)
