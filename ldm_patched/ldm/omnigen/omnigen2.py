...
from ldm_patched.ldm.lightricks.model import Timesteps
from ldm_patched.ldm.flux.layers import EmbedND
from ldm_patched.ldm.modules.attention import optimized_attention_masked
...
class OmniGen2Transformer2DModel(nn.Module):
    ...
    def flat_and_pad_to_seq(self, hidden_states, ref_image_hidden_states):
        ...
        if ref_image_hidden_states is not None:
            ref_image_hidden_states = list(map(lambda ref: ldm_patched.ldm.common_dit.pad_to_patch_size(ref, (p, p)), ref_image_hidden_states))
    ...
    def img_patch_embed_and_refine(self, hidden_states, ref_image_hidden_states, padded_img_mask, padded_ref_img_mask, noise_rotary_emb, ref_img_rotary_emb, l_effective_ref_img_len, l_effective_img_len, temb):
        ...
        if ref_image_hidden_states is not None:
            ...
            image_index_embedding = ldm_patched.modules.model_management.cast_to(self.image_index_embedding, dtype=hidden_states.dtype, device=hidden_states.device)
