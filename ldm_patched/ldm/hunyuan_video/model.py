...
import torch
import ldm_patched.ldm.flux.layers
...
class HunyuanVideo(nn.Module):
    ...
    def __init__(self, image_model=None, final_layer=True, dtype=None, device=None, operations=None, **kwargs):
        ...
        self.img_in = ldm_patched.ldm.modules.diffusionmodules.mmdit.PatchEmbed(None, self.patch_size, self.in_channels, self.hidden_size, conv3d=True, dtype=dtype, device=device, operations=operations)
