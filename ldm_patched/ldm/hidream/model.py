...
from ldm_patched.ldm.lightricks.model import TimestepEmbedding, Timesteps
import torch.nn.functional as F

from ldm_patched.ldm.flux.math import apply_rope, rope
...
class MoEGate(nn.Module):
    ...
    def forward(self, hidden_states):
        ...
        logits = F.linear(hidden_states, ldm_patched.modules.model_management.cast_to(self.weight, dtype=hidden_states.dtype, device=hidden_states.device), None)
