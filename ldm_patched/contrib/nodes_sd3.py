...
import nodes
import torch
import ldm_patched.contrib.nodes_slg


class TripleCLIPLoader:
    @classmethod
    def INPUT_TYPES(s):
        return {"required": { "clip_name1": (ldm_patched.utils.path_utils.get_filename_list("text_encoders"), ), "clip_name2": (ldm_patched.utils.path_utils.get_filename_list("text_encoders"), ), "clip_name3": (ldm_patched.utils.path_utils.get_filename_list("text_encoders"), )
                             }}
    RETURN_TYPES = ("CLIP",)
    FUNCTION = "load_clip"
    ...
    def load_clip(self, clip_name1, clip_name2, clip_name3):
        ...
        clip = ldm_patched.modules.sd.load_clip(ckpt_paths=[clip_path1, clip_path2, clip_path3], embedding_directory=ldm_patched.utils.path_utils.get_folder_paths("embeddings"))
        return (clip,)
...
class SkipLayerGuidanceSD3(ldm_patched.contrib.nodes_slg.SkipLayerGuidanceDiT):
    '''
